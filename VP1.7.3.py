...
in exampel 1.7
    ...
    b. find the magnitude and direction of \vec{T}. 
        State the direction of \vec{T} in terms of an angle measure counterclockwise
...
T_comp = vector_addition_2D(add_prepped_comp)
print(f'The components of Vector "T" are: x:{T_comp[1]}, y:{T_comp[2]}')
print(f'The angle and magnitude of T are: {(180 + (T_comp[0] * (180/math.pi)))}{chr(176)} and magnitude: { ((T_comp[1])**2 + (T_comp[2])**2)**.5 }')
